...
def main():
    # Update .env to use alwaysdata domain for now
    env_content = """DJANGO_SECRET_KEY=exzqjaP8LndPkQd0HmzNhdi7PRlLeMRX-YVZuDfcoNTjDl2zyjCIP-M0is_9lQNmOXEKsjFRsIEWvBxUbkbF-A
DJANGO_DEBUG=False
DJANGO_ALLOWED_HOSTS=sabistart.alwaysdata.net,sabistart.store,www.sabistart.store,.sabistart.store,localhost,127.0.0.1
DJANGO_CSRF_TRUSTED_ORIGINS=https://sabistart.alwaysdata.net,https://sabistart.store,https://www.sabistart.store,https://*.sabistart.store
...
"""
    ...
    stdout.read()
    ssh.close()
    print("Updated .env to use sabistart.alwaysdata.net as primary domain")

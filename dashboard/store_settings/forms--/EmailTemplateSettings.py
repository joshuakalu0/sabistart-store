...
class EmailTemplateSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'show_social_links_in_header': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'show_social_links_in_footer': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_unsubscribe_link': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

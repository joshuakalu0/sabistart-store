...
class HeaderSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'is_transparent': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            # === ANNOUNCEMENT BAR ===
            'show_announcement_bar': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            # === NAVIGATION ===
            'nav_style': forms.Select(attrs={'class': 'form-select'}),
            'show_categories_in_nav': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'search_style': forms.Select(attrs={'class': 'form-select'}),
            ...
            # === CART & ACCOUNT ===
            'show_cart_icon': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'cart_icon_style': forms.Select(attrs={'class': 'form-select'}),
            'show_cart_count': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'cart_preview_on_hover': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_account_icon': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_wishlist_icon': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === MOBILE MENU ===
            'mobile_menu_style': forms.Select(attrs={'class': 'form-select'}),
        }

...
class CartSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            # === CART TYPE ===
            'cart_type': forms.Select(attrs={'class': 'form-select'}),

            # === DRAWER SETTINGS ===
            'drawer_position': forms.Select(attrs={'class': 'form-select'}),
            ...
            # === CART BEHAVIOR ===
            'auto_open_on_add': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'auto_close_delay': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 0,
                'max': 30
            }),
            'show_continue_shopping': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'enable_cart_notes': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'enable_gift_message': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'enable_gift_wrapping': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'image_size': forms.Select(attrs={'class': 'form-select'}),
            'show_variant_details': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_remove_button': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'enable_quantity_update': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_unit_price': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_line_total': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === PRICING DISPLAY ===
            'show_item_subtotal': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_savings': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_tax_estimate': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_shipping_estimate': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_grand_total': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === UPSELLS & CROSS-SELLS ===
            'enable_cart_upsells': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'upsell_algorithm': forms.Select(attrs={'class': 'form-select'}),

            # === FREE SHIPPING PROGRESS ===
            'show_free_shipping_progress': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            # === DISCOUNT CODES ===
            'show_discount_code_field': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'discount_code_placeholder': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter discount code'
            }),
            'discount_code_position': forms.Select(attrs={'class': 'form-select'}),
            ...
            'checkout_button_style': forms.Select(attrs={'class': 'form-select'}),
            'show_secure_checkout_badge': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_accepted_payments': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'show_continue_shopping_on_empty': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_popular_products_on_empty': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            # === CART EXPIRY ===
            'enable_cart_expiry': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'cart_expiry_days': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 1,
                'max': 365
            }),
            'show_expiry_warning': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === STOCK WARNINGS ===
            'show_low_stock_warning': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'show_out_of_stock_warning': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'auto_remove_out_of_stock': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
        }

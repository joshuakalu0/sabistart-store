...
class NotificationSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'send_order_confirmation': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_order_processing': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_order_shipped': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_order_delivered': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_order_cancelled': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_order_refunded': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_order_on_hold': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === EMAIL NOTIFICATIONS - CUSTOMER ===
            'send_welcome_email': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_password_reset': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_account_verification': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_wishlist_reminder': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'send_abandoned_cart': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'send_back_in_stock': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_price_drop_alert': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_newsletter': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'send_promotional_emails': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === SMS NOTIFICATIONS ===
            'enable_sms': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'sms_provider': forms.Select(attrs={'class': 'form-select'}),
            'sms_order_confirmation': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'sms_order_shipped': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'sms_order_delivered': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'sms_order_cancelled': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'sms_verification_code': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === ADMIN NOTIFICATIONS ===
            'notify_admin_new_order': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'notify_admin_low_stock': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'low_stock_threshold': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 1,
                'max': 100
            }),
            'notify_admin_out_of_stock': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'notify_admin_new_review': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'notify_admin_new_customer': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'notify_admin_failed_payment': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'notify_admin_refund_request': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'respect_customer_timezone': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            ...
            'include_order_details_in_email': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'include_tracking_link': forms.CheckboxInput(attrs={'class': 'form-check-input'}),

            # === PUSH NOTIFICATIONS ===
            'enable_push_notifications': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'push_order_updates': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'push_promotional': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
        }

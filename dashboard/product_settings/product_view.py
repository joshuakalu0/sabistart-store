...
def product_edi(request, prefix, pk):
    """
    Create new product with all related forms and formsets
    Shares template with product_edit
    """
...
def get_attribute_values(request, prefix, attribute_id):
    """
    API endpoint to get attribute values for a specific attribute
    Used for dynamic loading of attribute values in the variant section
    """
    try:

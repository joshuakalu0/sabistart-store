...
DJANGO_DEBUG=False
DJANGO_ALLOWED_HOSTS=sabistart.alwaysdata.net,sho.sabistart.alwaysdata.net,sabistart.store,www.sabistart.store,.sabistart.store,localhost,127.0.0.1
DJANGO_CSRF_TRUSTED_ORIGINS=https://sabistart.alwaysdata.net,https://sho.sabistart.alwaysdata.net,https://sabistart.store,https://www.sabistart.store,https://*.sabistart.store
...
SUBDOMAIN_SUFFIX=.sabistart.alwaysdata.net
SERVER_IP=127.0.0.1
...
"""
    ...
    stdout.read()
    ssh.close()
    print("Updated server .env with sho.sabistart.alwaysdata.net")

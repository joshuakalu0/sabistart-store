...
CELERY_TASK_TIME_LIMIT = env_int("CELERY_TASK_TIME_LIMIT", 1800)  # 30 min hard limit for schema migrations
...
SESSION_COOKIE_DOMAIN = env_first("DJANGO_SESSION_COOKIE_DOMAIN", "SESSION_COOKIE_DOMAIN", default=None)
CSRF_COOKIE_DOMAIN = env_first("DJANGO_CSRF_COOKIE_DOMAIN", "CSRF_COOKIE_DOMAIN", default=SESSION_COOKIE_DOMAIN)
SESSION_COOKIE_SAMESITE = "Lax"
SESSION_COOKIE_SECURE = env_bool("DJANGO_SESSION_COOKIE_SECURE", default=env_bool("SESSION_COOKIE_SECURE", default=False))
CSRF_COOKIE_SECURE = env_bool("DJANGO_CSRF_COOKIE_SECURE", default=env_bool("CSRF_COOKIE_SECURE", default=False))
